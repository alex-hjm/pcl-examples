...
int main(int argc, char **argv)
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("pig.pcd", *cloud) == -1)
    {
    ...
    pcl::NormalEstimationOMP<pcl::PointXYZ, pcl::Normal> normEst; //其中pcl::PointXYZ表示输入类型数据，pcl::Normal表示输出类型,且pcl::Normal前三项是法向，最后一项是曲率
    normEst.setNumberOfThreads(8);
